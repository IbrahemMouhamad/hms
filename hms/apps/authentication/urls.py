...
from allauth.account.views import ConfirmEmailView, EmailVerificationSentView, AccountInactiveView
from allauth.account import app_settings as allauth_settings

from hms.apps.authentication.views import RegisterView
...
if settings.DJANGO_AUTH_TYPE == 'BASIC':
    urlpatterns += [
        ...
        path('inactive/', AccountInactiveView.as_view(),
